...
vim.keymap.set("n", "<leader>scb", "<cmd>lua require('fzf-lua').git_bcommits()<CR>", { desc = "[S]earch Git [B]commits" })
vim.keymap.set("n", "<leader>sw", "<cmd>lua require('fzf-lua').git_worktrees()<CR>", { desc = "[S]earch Git [W]orktrees" })
...
vim.keymap.set("n", "sg", "<cmd>lua require('fzf-lua').live_grep()<CR>", { desc = "[S]earch [G]rep" })
